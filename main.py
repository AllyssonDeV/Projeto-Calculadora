...
# .:cores:.
cor1="#212121" #cinza escuro
cor2="#ffffff" #branco
cor3="#00d5ff" #azul ciano
cor4="#d5edf2" #azul claro
cor5="#ff7b00" #laranja
cor6="#000000" #black
...
app_label = Label(frame_tela, textvariable=valor_texto, width= 16, height= 2, padx= 7, relief=FLAT, anchor="e", justify=RIGHT, font=("Ivy 18 "), bg= cor1, fg= cor3)
